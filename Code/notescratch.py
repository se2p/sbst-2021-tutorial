...
road_nodes = [(edges['middle'][0], edges['middle'][1], edges['middle'][2])  for edges in road_edges_by_beamng ]

print(road_nodes)
right_lane_center_polyline = LineString(road_nodes).parallel_offset(2.0, "right")